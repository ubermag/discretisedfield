...
def field_to_ovf(
    ...
    bheader = "".join(
        ...
        for line in [
            ...
            f'meshunit: {field.mesh.attributes["unit"]}',
            "meshtype: rectangular",
            f"xbase: {field.mesh.region.pmin[0] + field.mesh.cell[0]/2}",
            f"ybase: {field.mesh.region.pmin[1] + field.mesh.cell[1]/2}",
            f"zbase: {field.mesh.region.pmin[2] + field.mesh.cell[2]/2}",
            f"xnodes: {field.mesh.n[0]}",
            f"ynodes: {field.mesh.n[1]}",
            f"znodes: {field.mesh.n[2]}",
            f"xstepsize: {field.mesh.cell[0]}",
            f"ystepsize: {field.mesh.cell[1]}",
            f"zstepsize: {field.mesh.cell[2]}",
            f"xmin: {field.mesh.region.pmin[0]}",
            f"ymin: {field.mesh.region.pmin[1]}",
            f"zmin: {field.mesh.region.pmin[2]}",
            f"xmax: {field.mesh.region.pmax[0]}",
            f"ymax: {field.mesh.region.pmax[1]}",
            f"zmax: {field.mesh.region.pmax[2]}",
