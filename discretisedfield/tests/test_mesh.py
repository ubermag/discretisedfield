...
class TestMesh:
    def setup(self):
        self.valid_args = [[(0, 0, 0), (5, 5, 5), [1, 1, 1]],
                           [(0, 0, 0), (5e-9, 5e-9, 5e-9), (1e-9, 1e-9, 1e-9)],
                           [(-1.5e-9, -5e-9, 0), (1.5e-9, -15e-9, -10e-9), (0.15e-9, 0.1e-9, 10e-9)],
                           [(-1.5e-9, -5e-9, -5e-9), np.array((0, 0, 0)), (0.5e-9, 1e-9, 5e-9)],
                           [[0, 5e-6, 0], (-1.5e-6, -5e-6, -5e-6), (0.5e-6, 1e-6, 5e-9)],
                           [(0, 125e-9, 0), (500e-9, 0, -3e-9), (2.5e-9, 2.5e-9, 3e-9)]]

        self.invalid_args = [[(0, 0, 0), (5, 5, 5), (-1, 1, 1)],
    ...
    def test_domain_not_aggregate_of_cell(self):
        args = [[(0, 100e-9, 1e-9), (150e-9, 120e-9, 6e-9), (4e-9, 1e-9, 1e-9)],
