...
def test_cross(mesh_3d):
    ...
    assert np.allclose(
        (f1.cross(f2))((3e-8, 1e-8, 1e-8)), (-2e-16, -2e-16, 8e-16), atol=0
    )
    assert np.allclose(
        (f2.cross(f1))((3e-8, 1e-8, 1e-8)), (2e-16, 2e-16, -8e-16), atol=0
    )
    assert np.allclose(
        (f1.cross(f2))((5e-8, 3e-8, 1e-8)), (4e-16, -14e-16, 22e-16), atol=0
    )
