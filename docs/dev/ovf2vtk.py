...
def main():
    ...
    parser = argparse.ArgumentParser(
        prog='ovf2vtk',
        description='ovf2vtk -- data conversion from OOMMF`s omf/ovf file format to VTK.'
    )
    parser.add_argument('--infile', type=argparse.FileType('r'), nargs='+', required=True, 
        help='One or more input file')
