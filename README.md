...
| Description | Badge |
| --- | --- |
| Tests | [![tests](https://github.com/ubermag/discretisedfield/actions/workflows/tests.yml/badge.svg)](https://github.com/ubermag/discretisedfield/actions/workflows/tests.yml) |
